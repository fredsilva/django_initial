...
ADMINS = (
    ('Frederico da Silva Santos', 'fredsilva.sistemas@gmail.com'),
)
...
SECRET_KEY = 't1jzed76-v@@hd8)up(x04*8*v$y%%vg1fwy*(#y%03ef6o#a0'
...
LOGIN_URL = '/entrar/' #Url de login
LOGOUT_URL = '/sair/' #Url de logout
